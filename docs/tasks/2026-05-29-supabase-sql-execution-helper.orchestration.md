# Orchestration Plan: Supabase SQL execution helper

Source brief: `docs/tasks/2026-05-29-supabase-sql-execution-helper.md`
...
3. **Reviewer / QA** — verify edge cases and requirement fit.
4. **Release / Ops** — run release checks and confirm live state.

## Why These Roles Were Selected

- UI-sensitive work detected: **no**
...
4. Run a light UI sanity check if visible behavior changed.
...
When the task is done, answer with the final summary fields:

1. Changed
2. Verified
3. Design / UX judgment
4. Durable lesson
