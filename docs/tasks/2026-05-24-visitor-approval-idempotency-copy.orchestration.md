# Orchestration Plan: Fix visitor approval idempotency and user-facing copy

Source brief: `docs/tasks/2026-05-24-visitor-approval-idempotency-copy.md`
...
- [x] Existing product language to preserve is identified: operational Chinese wording without implementation details.
